...
Debian:
``` 
apt-get install bc tcpd zip tcl tcl-dev tcl-tls libssl-dev libflac-dev autoconf make diffutils ncftp git lynx curl mariadb-server lm-sensors smartmontools
``` 
